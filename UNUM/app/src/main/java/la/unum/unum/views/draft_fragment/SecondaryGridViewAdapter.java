 ...
 */
public class SecondaryGridViewAdapter extends ArrayAdapter<ImageView> {
    ...
    public SecondaryGridViewAdapter(Context context, int layoutResourceId, ArrayList<ImageView> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            holder.image = (ImageView) row.findViewById(R.id.secondarydraft_image);
            row.setTag(holder);
        } else {
        ...
        if (item == null)
            holder.image.setBackgroundColor(Color.rgb(241, 238, 237));
        return row;
    }
